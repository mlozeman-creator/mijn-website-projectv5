...
// Check voor Admin-rol (Partnerhub) via URL parameter
...
<div class="bg-dark text-white py-2 small text-center fw-bold fixed-top" style="z-index: 2000;">
    🚀 PARTNERHUB ACTIEF | <a href="?page=home" class="text-danger text-decoration-none ms-2">BEËINDIG SESSIE</a>
</div>
<?php endif; ?>
    ...
    <?php if ($articleSlug): ?>
        ...
        if ($post): ?>
            <div class="row justify-content-center mb-5">
                <div class="col-lg-8">
                    <nav class="mb-4"><a href="?page=home<?php echo $adminParam; ?>" class="text-decoration-none fw-bold text-muted small">← TERUG NAAR OVERZICHT</a></nav>
                    <div class="bg-white p-4 p-md-5 rounded-5 shadow-sm border">
                        ...
                        <div class="d-flex align-items-center mb-4">
                            <span class="badge bg-primary-subtle text-primary rounded-pill px-3 py-2 me-3"><?php echo strtoupper($post['category']); ?></span>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="text-center mb-5">
                    ...
                    <p class="lead text-muted">Een moderne serverless stack aangedreven door CI/CD</p>
                </div>
                <div class="row g-4">
                    <div class="col-md-7">
                        <div class="p-5 bg-white rounded-5 shadow-sm border h-100">
                            ...
                            <p class="text-muted">Workflow uit <code>README.md</code> voor live publicatie:</p>
                            <div class="bg-dark text-info p-4 rounded-4 font-monospace shadow-sm mt-3" style="font-size: 0.85rem;">
                                <span class="text-secondary opacity-50"># Push naar Vercel Edge</span><br>
                    ...
                    <div class="col-md-5">
                        <div class="p-5 bg-white rounded-5 shadow-sm border h-100">
                            ...
                            <div class="list-group list-group-flush mb-4">
                                ...
                                <div class="list-group-item border-0 px-0 d-flex justify-content-between align-items-center">
                                    <span class="text-muted small">Framework</span><span class="badge bg-dark rounded-pill">BS 5.3</span>
                                </div>
                            </div>
                            <?php if($isAdmin): ?>
                                <div class="p-4 bg-primary rounded-4 text-white shadow-sm mt-3">
                                    <h6 class="fw-bold mb-2 text-warning small">PARTNERHUB DASHBOARD</h6>
                                    <div class="small opacity-75 mb-3">Gegevens live uit <code>content.json</code>.</div>
                                    <a href="<?php echo $data['author']['github_url']; ?>/edit/main/data/content.json" target="_blank" class="btn btn-light btn-sm w-100 fw-bold text-primary">Manage Database</a>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
        ...
        <div class="row justify-content-center text-center">
            <div class="col-md-6 bg-white p-5 rounded-5 shadow-lg border">
                ...
                <div class="d-grid gap-2 d-md-block">
                    <a href="mailto:<?php echo $data['author']['email']; ?>" class="btn btn-primary px-5 py-3 rounded-pill fw-bold shadow-sm">Email Mij</a>
                </div>
            </div>
        </div>

    <?php else: ?>
        <header class="hero text-center mb-5 rounded-5 mx-2">
            <div class="container">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card card-blog shadow-sm">
                    ...
                    <div class="card-body p-4 d-flex flex-column">
                        ...
                        <?php if($isAdmin): ?>
                            <div class="mt-3 pt-2 border-top small text-center"><span class="text-danger fw-bold">Admin:</span> ID #<?php echo $post['id']; ?></div>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
