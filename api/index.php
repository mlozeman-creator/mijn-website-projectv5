...
$wordCounts = array_map(function($a) {
    return str_word_count(strip_tags($a['content']));
}, $data['articles']);

$avgWords = $totalArticles > 0
    ? round(array_sum($wordCounts) / $totalArticles)
    : 0;
...
";
        ...
        $headers = "From: noreply@webedu.nl\r\n";
...
<?php if($isAdmin): ?>
    <div class="admin-sidebar active">
        ...
        <small class="text-info fw-bold">
            Versie: <?php echo $systemVersion; ?>
        </small>

        <div class="p-4 bg-white bg-opacity-10 rounded-4 my-4 border border-white border-opacity-10 text-white">

            <small class="text-uppercase text-warning fw-bold d-block mb-3">
                Live Payload Metrics
            </small>
            ...
            <div class="d-flex justify-content-between mb-2">
                <span>Avg Words:</span>
                <strong><?php echo $avgWords; ?></strong>
            </div>

            <div class="d-flex justify-content-between">
                <span>Edge Status:</span>
                <span class="text-success fw-bold text-dark">ONLINE</span>
            </div>
        </div>

        <div class="d-grid gap-3">
            <a href="<?php echo $data['author']['github_url']; ?>/edit/main/data/content.json"
               target="_blank"
            ...
            <a href="?page=home"
               class="btn btn-outline-danger btn-sm rounded-pill fw-bold py-2">
                Logout Admin
            </a>
        </div>
    </div>
...
<nav class="navbar navbar-expand-lg fixed-top shadow-sm <?php echo $isAdmin ? 'admin-mode-nav' : ''; ?>">
    ...
    <div class="container">
        ...
        <a class="navbar-brand fw-extrabold text-dark fs-3"
           href="?page=home<?php echo $adminParam; ?>">
            WEB<span class="text-primary">.EDU</span>
        </a>
        ...
        <div class="navbar-nav ms-auto align-items-center">
            ...
            <a class="nav-link fw-bold text-dark px-3"
               href="?page=tech<?php echo $adminParam; ?>">
                Cloud Stack
            </a>

            <a class="nav-link fw-bold text-dark px-3"
               href="?page=author<?php echo $adminParam; ?>">
                Architect
            </a>

            <?php if($isAdmin): ?>
                <span class="badge bg-danger ms-3 px-3 py-2 fw-bold">
                    HBO DEV MODE
                </span>
            <?php endif; ?>
    ...
    <?php if ($post): ?>
        ...
        <div class="row justify-content-center mb-5">
            ...
            <div class="col-lg-9">
                ...
                <nav class="mb-4">
                    <a href="?page=home<?php echo $adminParam; ?>"
                ...
                <article class="bg-white p-5 rounded-5 shadow-sm border text-dark">
                    ...
                    <img src="<?php echo $post['image']; ?>"
                         class="w-100 rounded-4 mb-5 shadow-lg"
                         style="max-height: 450px; object-fit: cover;">

                    <span class="badge bg-primary-subtle text-primary rounded-pill px-4 py-2 fw-bold mb-3">
                        <?php echo strtoupper($post['category']); ?>
                    </span>

                    <h1 class="display-4 fw-extrabold mb-4 text-dark">
                        <?php echo htmlspecialchars($post['title']); ?>
                    </h1>

                    <div class="lh-lg fs-5 text-dark article-body">
    ...
    <div class="row justify-content-center text-dark">
        ...
        <div class="col-lg-10 text-dark">
            ...
            <div class="p-5 bg-white rounded-5 shadow-sm border text-dark">
                ...
                <h2 class="display-5 fw-extrabold mb-4">
                    Cloud-Native Architectuur
                </h2>

                <p class="fs-5 text-muted mb-5 text-dark">
                    Als HBO Webdeveloper focus ik op schaalbaarheid en statelessness.
                    Dit project draait op de Vercel Edge-runtime via PHP 8.3 Serverless Functions.
                </p>

                <div class="bg-dark p-4 rounded-4 shadow-lg mb-4 text-info font-monospace">
...
<?php elseif ($page === 'author'): ?>
    ...
    <div class="row justify-content-center text-center text-dark">
        ...
        <div class="col-md-7 bg-white p-5 rounded-5 shadow-lg border text-dark">
            ...
            <img src="https://ui-avatars.com/api/?name=Mark+Lozeman&size=160&background=6366f1&color=fff"
                 class="rounded-circle mb-4 border border-5 border-white shadow-lg">

            <h2 class="fw-extrabold text-dark display-6">
                <?php echo htmlspecialchars($data['author']['name']); ?>
            </h2>

            <p class="badge bg-dark px-4 py-2 rounded-pill mb-4 text-white">
                HBO Webdeveloper
            </p>

            <p class="text-muted fs-5 mb-5 lh-base px-4 text-dark">
                <?php echo htmlspecialchars($data['author']['bio']); ?>
            </p>

            <button class="btn btn-primary px-5 py-3 rounded-pill fw-bold shadow-sm"
...
<?php else: ?>
    ...
    <header class="hero text-center mb-5 rounded-5 mx-2 shadow-lg">
        ...
        <div class="container">
            ...
            <h1 class="display-2 fw-extrabold mb-3 text-white">
                HBO Web Masterclass
            </h1>

            <p class="lead opacity-90 mx-auto fs-4 text-white"
               style="max-width: 800px;">

                Een diepgaand curriculum over moderne web-architectuur
                voor de MBO-4 professional.
    ...
    <div class="d-flex justify-content-center gap-3 flex-wrap mb-5"
        ...
        <a href="?page=home&filter=alles<?php echo $adminParam; ?>"
           class="filter-btn <?php echo $filter === 'alles' ? 'active' : ''; ?>">
            Alle Modules
        </a>

        <?php foreach($categories as $cat): ?>

            <a href="?page=home&filter=<?php echo urlencode($cat) . $adminParam; ?>"
               class="filter-btn <?php echo strtolower($filter) === strtolower($cat) ? 'active' : ''; ?>">
            ...
            <div class="col-md-6 col-lg-4 text-dark">
                ...
                <div class="card card-blog shadow-sm text-dark">
                    ...
                    <div class="card-body p-4 d-flex flex-column text-dark">
                        ...
                        <p class="text-muted small mb-4 text-dark">
                            <?php echo substr(strip_tags($post['content']), 0, 110); ?>...
                        </p>

                        <a href="?page=home&article=<?php echo $post['slug'] . $adminParam; ?>"
                           class="mt-auto btn btn-outline-dark rounded-pill py-2 fw-bold">
